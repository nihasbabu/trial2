...
import sty from "./PlasmicButton.module.css"; // plasmic-import: J16MKnFB4PJz/css
    ...
    >
      ...
      {(
        ...
        ? renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__k9RJx)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__mhmFl)}
                role={"img"}
              />
            ),
